...
export const appConfig = {
    ...
    contentsFileUrl: 'https://api.github.com/repos/OP-TED/eForms-SDK/contents',
    thresholdVersion: '1.3.2',  // versions before this one are not displayed in the dropdown
};
